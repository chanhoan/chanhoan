...
### 💻 프로젝트
- [omisys](https://github.com/chanhoan/omisys) : 대규모 트래픽 처리를 위한 MSA 기반 이커머스 백엔드 시스템 🛒
- [hi-five](https://github.com/team-hi-five) : 자폐 스펙트럼 장애 아동의 감정 학습을 위한 교육 플랫폼 👨‍👩‍👧‍👦
- [gittowork](https://github.com/Git-To-Work) : GitHub 활동 데이터와 최신 채용 정보를 결합하여, 사용자의 기술 스택과 경력에 최적화된 직무 및 기업을 추천하는 맞춤형 모바일 앱📱
